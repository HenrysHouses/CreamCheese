...
public class DebuffBase : MonoBehaviour
{
    ...
    ///<Summary> Use this to apply debuffs that should happen when the player honks the horn (Happens when playing cards) </Summary>
    public virtual void OnCardsPlayedTickDebuff(int _ticks = 1){}
