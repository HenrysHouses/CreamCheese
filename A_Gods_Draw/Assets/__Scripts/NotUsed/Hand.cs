...
{   
   /*public class CardInHand
    ...
    public void AddCard(Card_Selector card)
    {
        ...
        card.gameObject.transform.SetParent(newPivotPoint.transform);
        // listOfCards.Add(instance);
        card.Target = newPivotPoint.transform.position + new Vector3(2,0f,0);
